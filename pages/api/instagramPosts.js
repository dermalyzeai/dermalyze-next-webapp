...
export default async function handler(req, res) {
    ...
    const postsApiUrl = `https://graph.instagram.com/me/media?fields=id,media_type,media_url,caption,timestamp,permalink,children{media_type,media_url}&access_token=${INSTAGRAM_ACCESS_TOKEN}`;
